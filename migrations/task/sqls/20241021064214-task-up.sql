...
update  "USER" 
set role = 'COACH'
where email in (select email from "USER" where email in ('lee2000@hexschooltest.io', 'muscle@hexschooltest.io', 'starplatinum@hexschooltest.io'));

-- 1-3 刪除：刪除USER 資料表中，用 Email 找到透明人，並刪除該筆資料
delete from "USER" where email = (select email from "USER" where email = 'opacity0@hexschooltest.io');
